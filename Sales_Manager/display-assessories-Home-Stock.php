                          ...
                          <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel1">Accessories Stock Detail</h5>
                                <button
                                  type="button"
                                  class="btn-close"
...
show_code();
    ...
    $.ajax({ 
           url:'../php/manager-display-accessories-home-stock.php',
            type:'GET',
            data:queryString,
             // beforeSend: function () {
             //        $('#Refresh').show();
...
function increse_product_job_stock(data){
        $.ajax({
                url: '../php/manager-increase-accessories-job-stock-form.php',
                type: 'POST',
                data: {
                  data:data
                },
          ...
          $("#form_increase_job_stock_product").validate({
            ...
            unhighlight: function (element, errorClass, validClass) {
             ...
             var f = $("#form_increase_job_stock_product")[0];
              ...
              $.ajax({
                url: '../php/manager_increase_accessories_job_stock.php',
                type: 'post',
                data: form,
                cache: false,
                processData: false,
