...
show_code();
    ...
    $.ajax({ 
           url:'../php/manager-display-accessoris-damaged.php',
            type:'GET',
            data:queryString,
             // beforeSend: function () {
             //        $('#Refresh').show();
...
function delete_damaged_acces(data){
        $.ajax({
                url: '../php/manager_delete_accessories_damaged.php',
                type: 'POST',
                data: {
                  data:data
                },
              dataType:"json",
              beforeSend:function(){
                return confirm('Are You Sure You Want To Return This Accessories Damaged  in stock ?');
              },
