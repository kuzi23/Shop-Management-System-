          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- Bootstrap modals -->
                ...
                <div class="card" id="product_client_status_dispaly">
...
show_code();
    ...
    $.ajax({ 
           url:'../php/sales_manager-display-product-client-status.php',
            type:'GET',
            data:queryString,
             // beforeSend: function () {
             //        $('#Refresh').show();
            ...
            success: function(data) {
                $('#product_client_status_dispaly').html(data);

            },
     });
};
function product_sold_sms(data){
        $.ajax({
                url: '../php/manager-remind-product-sold-form.php',
                type: 'POST',
                data: {
                  data:data
                },
          ...
          $("#form_sold_accessories_remind").validate({
            ...
            unhighlight: function (element, errorClass, validClass) {
             ...
             var f = $("#form_sold_accessories_remind")[0];
              ...
              $.ajax({
                url: '../php/manager_reminder_send_sms_product.php',
                type: 'post',
                data: form,
                cache: false,
                processData: false,
                contentType: false,
                beforeSend: function () {
                    $('#send_message').html('Sending<i class="fa fa-solid fa-spinner fa-spin"></i>');
