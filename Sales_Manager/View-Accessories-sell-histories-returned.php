...
show_code();
    ...
    $.ajax({ 
           url:'../php/manager-display-accessories-sells-returned-history.php',
            type:'GET',
            data:queryString,
             // beforeSend: function () {
             //        $('#Refresh').show();
...
function update_returned_product_sold(data){
        $.ajax({
                url: '../php/manager-update-accessories-sold-returned-form.php',
                type: 'POST',
                data: {
                  data:data
                },
          ...
          $("#update_product_sold_returned").validate({
            ...
            unhighlight: function (element, errorClass, validClass) {
             ...
             var f = $("#update_product_sold_returned")[0];
              ...
              $.ajax({
                url: '../php/manager_insert_return_accessories_location.php',
                type: 'post',
                data: form,
                cache: false,
                processData: false,
