  ...
  function show_clients(str){
    if (str == '') {
      ...
      if (this.readyState  == 4 && this.status == 200) {
       ...
       xmlhttp.open("GET","../php/xml_show_client_categories.php?categorie="+str ,true);
       xmlhttp.send();
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card mb-4">
                ...
                <div class="container">
                    <form id="client_procced" method="POST">
                <div class="row">
                    <div class="col-md-3">
                        <label>Client Categories</label>
                        <select name="categorie" class="form-control" onclick="show_clients(this.value)">
...
$(document).ready(function () {
    $("#client_procced").validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: '../php/manager_Progress_client.php',
                type: 'post',
                data: formData,
                cache: false,
                processData: false,
