...
show_code();
    ...
    $.ajax({ 
           url:'../php/manager-display-product-damaged.php',
            type:'GET',
            data:queryString,
             // beforeSend: function () {
             //        $('#Refresh').show();
...
function delete_damaged(data){
        $.ajax({
                url: '../php/manager_delete_product_damaged.php',
                type: 'POST',
                data: {
                  data:data
                },
              dataType:"json",
              beforeSend:function(){
                return confirm('Are You Sure You Want To Return This Product Damaged  in stock ?');
              },
