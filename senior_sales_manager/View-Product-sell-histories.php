...
show_code();
    ...
    $.ajax({ 
           url:'../php/senior_manager-display-product-sells-history.php',
            type:'GET',
            data:queryString,
             // beforeSend: function () {
             //        $('#Refresh').show();
...
<script>
        $(document).ready(function () {
          $("#form_returned_sold_product_update").validate({
            rules: {
              returned_quantity:{
                    required: true,
                },
            ...
            unhighlight: function (element, errorClass, validClass) {
             ...
             var f = $("#form_returned_sold_product_update")[0];
              var form = new FormData(f);
              $.ajax({
                url: '../php/manager_insert_return_product_sold.php',
                type: 'post',
                data: form,
                cache: false,
                processData: false,
              ...
              success: function(dataResult){
                alert(dataResult);
                 if(dataResult == 1){
                  ...
                  $("#error-displayss").html("Returned Product Already Recored!!");
                  fetch();
                }
                  ...
                  $("#error-displayss").removeClass('alert-success');
                  $("#error-displayss").addClass('alert-success');
                  $("#error-displayss").html("Returned Product Well Recored!!");
                  fetch();
                }
                else {
                  $("#error-displayss").show();
                  ...
                  $("#error-displayss").html("Returned Product Failed To Be Recorded !!");
                  fetch();
                }
