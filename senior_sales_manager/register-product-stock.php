  ...
  function show_product_type(str){
    if (str == '') {
      ...
      if (this.readyState  == 4 && this.status == 200) {
       ...
       xmlhttp.open("GET","../php/xml_product_type.php?p_id="+str ,true);
       xmlhttp.send();
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- Bootstrap modals -->
              <div class="card mb-4">
                <h5 class="card-header">Register Product Stock</h5>
                <div class="card-body">
                  <div class="row gy-3">
                    <!-- Default Modal -->
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel1">Product Stock</h5>
                                <button
                                  type="button"
                                  class="btn-close"
                              ...
                              <div class="modal-body">
                                ...
                                <div class="row">
                                  <div class="col mb-3">
                                    ...
                                    <select name="p_id" class="form-control" onclick="show_product_type(this.value)">
                                    ...
                                    ?>
                                    <option value="<?php echo $row_ccselect_product['p_id']?>"><?php echo $row_ccselect_product['product_name'];?></option>
                                    <?php
                                    }
                                    ?>
                                    </select>
                                ...
                                <div class="row" id="display_sub_type">
                                  <div class="col mb-3">
             ...
             var f = $("#form_product_price_update")[0];
              ...
              success: function(dataResult){
                 ...
                 if(dataResult == 1){
                  ...
                  $("#error-displays").html("Product Price Already Exit !!");
                  fetch();
                }
